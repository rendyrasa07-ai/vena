...
export const MOCK_USERS: User[] = [
    { id: ADMIN_USER_ID, email: 'admin@vena.pictures', password: 'admin', fullName: 'Andi Vena', companyName: 'Vena Pictures', role: 'Admin', isApproved: true },
    { id: MEMBER_USER_ID, email: 'member@vena.pictures', password: 'member', fullName: 'Rina Asisten', companyName: 'Vena Pictures', role: 'Member', permissions: [ViewType.CLIENTS, ViewType.PROJECTS, ViewType.CALENDAR, ViewType.SOCIAL_MEDIA_PLANNER], isApproved: true },
];
